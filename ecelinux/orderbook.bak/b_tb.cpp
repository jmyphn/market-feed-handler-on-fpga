...
void order_book(stream<order> &order_stream,
				        stream<Time> &incoming_time,      // input
				        stream<metadata> &incoming_meta,  // input
				        stream<order> &top_bid,           // output
				        stream<order> &top_ask,           // output
				        stream<Time> &outgoing_time,      // output
				        stream<metadata> &outgoing_meta,  // output
                ap_uint<32> &top_bid_id,          // output
                ap_uint<32> &top_ask_id);         // output
