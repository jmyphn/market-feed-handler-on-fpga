#include "b_priority_queue.hpp"

int log_base_2(unsigned index){
#pragma HLS INLINE
    // THINK: lookup table used here, is this faster than computing yourself?
...
#pragma HLS INLINE
    // THINK(tean): can index=0? not sure at the moment. but if no, this could be odd...
...
/*
 * input heap: priority queue for bids
 * input new_order
 * heap_counter: TODO
 * hole_counter: TODO
 * hold_idx:     TODO
